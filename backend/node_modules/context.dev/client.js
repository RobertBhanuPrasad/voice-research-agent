...
var _ContextDev_instances, _a, _ContextDev_encoder, _ContextDev_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ContextDev = void 0;
...
const ai_1 = require("./resources/ai.js");
const brand_1 = require("./resources/brand.js");
const industry_1 = require("./resources/industry.js");
const utility_1 = require("./resources/utility.js");
const web_1 = require("./resources/web.js");
...
class ContextDev {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('CONTEXT_DEV_BASE_URL'), apiKey = (0, env_1.readEnv)('CONTEXT_DEV_API_KEY'), ...opts } = {}) {
        _ContextDev_instances.add(this);
        _ContextDev_encoder.set(this, void 0);
        this.web = new API.Web(this);
        this.ai = new API.AI(this);
        this.brand = new API.Brand(this);
        this.industry = new API.Industry(this);
        this.utility = new API.Utility(this);
        if (apiKey === undefined) {
            throw new Errors.ContextDevError("The CONTEXT_DEV_API_KEY environment variable is missing or empty; either provide it, or instantiate the ContextDev client with an apiKey option, like new ContextDev({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('CONTEXT_DEV_LOG'), "process.env['CONTEXT_DEV_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _ContextDev_encoder, Opts.FallbackEncoder, "f");
        const customHeadersEnv = (0, env_1.readEnv)('CONTEXT_DEV_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _ContextDev_instances, "m", _ContextDev_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _ContextDev_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.ContextDev = ContextDev;
_a = ContextDev, _ContextDev_encoder = new WeakMap(), _ContextDev_instances = new WeakSet(), _ContextDev_baseURLOverridden = function _ContextDev_baseURLOverridden() {
    return this.baseURL !== 'https://api.context.dev/v1';
};
ContextDev.ContextDev = _a;
ContextDev.DEFAULT_TIMEOUT = 60000; // 1 minute
ContextDev.ContextDevError = Errors.ContextDevError;
ContextDev.APIError = Errors.APIError;
ContextDev.APIConnectionError = Errors.APIConnectionError;
ContextDev.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
ContextDev.APIUserAbortError = Errors.APIUserAbortError;
ContextDev.NotFoundError = Errors.NotFoundError;
ContextDev.ConflictError = Errors.ConflictError;
ContextDev.RateLimitError = Errors.RateLimitError;
ContextDev.BadRequestError = Errors.BadRequestError;
ContextDev.AuthenticationError = Errors.AuthenticationError;
ContextDev.InternalServerError = Errors.InternalServerError;
ContextDev.PermissionDeniedError = Errors.PermissionDeniedError;
ContextDev.UnprocessableEntityError = Errors.UnprocessableEntityError;
ContextDev.toFile = Uploads.toFile;
ContextDev.Web = web_1.Web;
ContextDev.AI = ai_1.AI;
ContextDev.Brand = brand_1.Brand;
ContextDev.Industry = industry_1.Industry;
ContextDev.Utility = utility_1.Utility;
