...
import type { ContextDev } from "../client.mjs";
 ...
 */
export declare const maybeMultipartFormRequestOptions: (opts: RequestOptions, fetch: ContextDev | Fetch) => Promise<RequestOptions>;
type MultipartFormRequestOptions = Omit<RequestOptions, 'body'> & {
    body: unknown;
};
export declare const multipartFormRequestOptions: (opts: MultipartFormRequestOptions, fetch: ContextDev | Fetch) => Promise<RequestOptions>;
export declare const createForm: <T = Record<string, unknown>>(body: T | undefined, fetch: ContextDev | Fetch) => Promise<FormData>;
export {};
