...
export declare class Web extends APIResource {
     ...
     * ```
     */
    extractCompetitors(query: WebExtractCompetitorsParams, options?: RequestOptions): APIPromise<WebExtractCompetitorsResponse>;
    /**
...
export declare namespace WebExtractResponse {
    interface Metadata {
...
export declare namespace WebExtractCompetitorsResponse {
...
export interface WebExtractFontsResponse {
     ...
     */
    fontLinks?: {
        [key: string]: WebExtractFontsResponse.FontLinks;
    };
    /**
     * Metadata about the API key used for the request. Included in every response
     * whenever a valid API key is provided, even when the response status is not 200.
...
export declare namespace WebExtractFontsResponse {
    interface Font {
        /**
...
export declare namespace WebExtractStyleguideResponse {
    /**
     * Metadata about the API key used for the request. Included in every response
     * whenever a valid API key is provided, even when the response status is not 200.
     */
    ...
    interface Styleguide {
         ...
         */
        fontLinks: {
            [key: string]: Styleguide.FontLinks;
        };
        /**
...
export declare namespace WebScreenshotResponse {
    /**
     * Metadata about the API key used for the request. Included in every response
     * whenever a valid API key is provided, even when the response status is not 200.
     */
...
export declare namespace WebSearchResponse {
    interface Result {
        /**
...
export declare namespace WebWebCrawlMdResponse {
    interface Metadata {
        /**
...
export declare namespace WebWebScrapeHTMLResponse {
    /**
     * Metadata about the API key used for the request. Included in every response
     * whenever a valid API key is provided, even when the response status is not 200.
     */
...
export declare namespace WebWebScrapeMdResponse {
    /**
     * Metadata about the API key used for the request. Included in every response
     * whenever a valid API key is provided, even when the response status is not 200.
     */
...
export declare namespace WebExtractParams {
    interface Pdf {
        /**
...
export declare namespace WebScreenshotParams {
    /**
     * Optional browser viewport dimensions for the screenshot. Defaults to 1920x1080.
     */
    interface Viewport {
...
export declare namespace WebSearchParams {
    /**
     * Inline Markdown scraping for each result. Set `enabled: true` to activate.
     */
...
export declare namespace WebWebCrawlMdParams {
    /**
     * PDF parsing controls. Use start/end to limit text extraction and OCR to an
     * inclusive 1-based page range.
     */
...
export declare namespace WebWebScrapeHTMLParams {
    /**
     * PDF parsing controls. Use start/end to limit text extraction and OCR to an
     * inclusive 1-based page range.
     */
...
export declare namespace WebWebScrapeImagesParams {
    /**
     * Optional per-image processing, sent as deep-object query params such as
     * enrichment[resolution]=true.
     */
...
export declare namespace WebWebScrapeMdParams {
    /**
     * PDF parsing controls. Use start/end to limit text extraction and OCR to an
     * inclusive 1-based page range.
     */
