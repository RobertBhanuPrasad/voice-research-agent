...
export declare class Industry extends APIResource {
    /**
...
export declare namespace IndustryRetrieveNaicsResponse {
    interface Code {
        /**
         * NAICS code
         */
...
export declare namespace IndustryRetrieveSicResponse {
    interface Code {
        /**
         * SIC code (4-digit).
         */
...
export declare namespace Industry {
    export { type IndustryRetrieveNaicsResponse as IndustryRetrieveNaicsResponse, type IndustryRetrieveSicResponse as IndustryRetrieveSicResponse, type IndustryRetrieveNaicsParams as IndustryRetrieveNaicsParams, type IndustryRetrieveSicParams as IndustryRetrieveSicParams, };
}
//# sourceMappingURL=industry.d.mts.map